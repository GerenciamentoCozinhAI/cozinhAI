  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      <div className="flex flex-grow flex-col md:flex-row">
                ...
                >
                  <div className="flex flex-col items-center">
                    ...
                    >
                      ...
                      <path
                        d="M40 40C40 35.5817 43.5817 32 48 32H72C76.4183 32 80 35.5817 80 40V88C80 88 72 80 60 80C48 80 40 88 40 88V40Z"
                        stroke="currentColor"
                        strokeWidth="4"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    ...
                    <h2 className="text-xl font-semibold mb-2">Comece sua jornada culinária</h2>
                    <p className="text-center opacity-90">
                      Crie uma conta e tenha acesso a recursos exclusivos para aprimorar suas habilidades na cozinha
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-6">
          <div className="w-full max-w-md">
            <h2 className="text-3xl font-bold text-green-800 mb-6 text-center">Cadastro</h2>
            {success && (
      ...
      <div className="bg-white py-4 text-center text-gray-600 border-t border-gray-200">
        <p>© {currentYear} CozinhAI. Todos os direitos reservados.</p>
      </div>
    </div>
  )
}