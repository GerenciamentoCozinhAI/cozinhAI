...
export async function generateRecipe(
  ...
  try {
    ...
    const config = {
      ...
      systemInstruction: [
        {
        text: `Você vai gerar uma receita com base nos ingredientes que eu passar (Caso não passe ingrediente adicione você os que quiser). Cada ingrediente possui nome, quantidade e unidade (em casos como "Sal a gosto", a quantidade é 0 e a unidade é "a gosto"). Você pode adicionar ingredientes extras **apenas se absolutamente necessário e o usuario indicar isso na observação** para coerência da receita. Sempre respeite todas as observações do usuário (como restrições alimentares ou preferências). Seja detalhado nas instruções. A dificuldade vai de 1 (pipoca) a 10 (alta gastronomia), com exemplos intermediários como 4 (lasanha) e 8 (sushi). o whatIs é a definição da receita em ingles, como "chocolate pancake", "tomato soup", "salad","flavored water lime", "BBQ" etc.`,
        },
      ],
    };
